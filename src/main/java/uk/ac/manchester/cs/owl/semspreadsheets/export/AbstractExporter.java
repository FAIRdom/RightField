...
/**
 * Handles the common tasks of exporting populated data validations, allowing
 * subclasses to export in their varous flavours. The key method is
 * {@link #getPopulatedValidatedCellDetails()} which returns a list of details
 * of all the cells that have been annotated, and a term selected, together with
 * information about where that term came from.
 * 
 * @author Stuart Owen
 * 
