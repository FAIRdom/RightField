...
/**
 * Container panel for selecting or showing the validation and properties that
 * are going to be applied to the cells. The container includes available class
 * hierarchies for each ontology loaded, the list of validation types,
...
public class ValidationInspectorPanel extends JPanel {
    ...
    private void addValidationSelectionPanel(WorkbookFrame frame) {
        ...
        ValidationValuesPanel valuesPanel = new ValidationValuesPanel(frame.getWorkbookManager(), this);
